...
To simulate a dynamical loading situation where the manipulator would be in the highest loading scenario, gravitational forces and an outward force (parallel to the arm direction in it's zeroed configuration) was applied to the structure. This situation represents the worst-case loading scenario, such as the manipulator swinging while outstretched. The supports and simulated forces can be seen in the ANSYS image capture shown in \emph{Figure \ref{fig:ansys_forces}}.
...
\end{figure}
As shown in \emph{Figure \ref{fig:ansys_forces}}, the red arrow is the outward force, the yellow arrow represents gravity acting at the manipulator's center of mass, and the yellow highlighted faces show the fixed support at the base.
...
\begin{subfigure}[t]{0.4\textwidth}
  \center
  \includegraphics[width=.8\textwidth,frame]{ansys_bearing}
...
To further validate that the structure is capable of handling the load cases, a fatigue test was also performed and the life of the manipulator exceeds 10e8 cycles, as seen in \emph{Figure \ref{ansys_life}}, showing it is unlikely to fail due to material yeilding.
...
\multirow{2}{*}{2 Sch 10 12" Al tube} & Industrial Metal Sales & 1 & 2.99 & 2.99 \\\cline{2-2}
