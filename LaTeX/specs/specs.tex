...
\begin{enumerate}[label=\thesubsubsection.\alph*,leftmargin=3cm,font=\itshape]
  \item \textit{Joint one and two of the system shall possess an angle error of no more than .05 degrees.}
  \item \textit{Joint three of the system shall possess an angle error of no more than .1 degrees.}
  \item \textit{Joints four, five, and six shall possess an angle error of no more than .3 degrees.}
\end{enumerate}
